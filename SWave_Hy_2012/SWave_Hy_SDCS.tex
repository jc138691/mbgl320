...
\eeq
where (i) ${\bf K}_\gamma$ is the $\gamma$'th column of the $K$-matrix; (ii) superscript 'T' denotes transpose;
and (iii) $s_\gamma$ and the vector ${\bf C}$ components are given by
\beq \barr{l}
...
b_i = \vecCT {\bf W}  {\bf B}_i, \ \ \
x_\gamma = \vecCT {\bf W}  {\bf X}_\gamma,
\earr \eeq
