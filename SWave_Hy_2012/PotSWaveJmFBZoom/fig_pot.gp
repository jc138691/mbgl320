...
JM_OLD  = '../../output/PotSWaveJm/PotSWaveJm_R_L0_LMBD1.0_N10.dat'

JM_1  = '../../output/PotSWaveJmCorr/PotSWaveJmCorr_R_L0_LMBD1.0_N10_TAIL1.dat'
JM_2  = '../../output/PotSWaveJmCorr/PotSWaveJmCorr_R_L0_LMBD1.0_N10_TAIL2.dat'
...
p \
  ...
  JM_2 u ($1):($2) t 'TAIL2' w l ls 12, \
  JM_OLD u ($1):($2) t 'OLDN10' w l ls 11
