...
set term postscript eps enhanced lw 1 size 8.6cm,15cm solid color 18 "fixed"; set out 'fig1b.ps'
...
set key right center Right title "(b) 2^3S [x0.01]"
p \
...
set xrange [E_2S1-0.1:E_3S3+0.1];  set xtics 0.5;    set mxtics 5;   set format x "%4.1f"; 
set yrange [0.0:1.5];            set ytics 0.5;  set mytics 5;   set format y "%3.1f"; 
set key right center Right title "(c) 2^1S [x0.01]"
p \
