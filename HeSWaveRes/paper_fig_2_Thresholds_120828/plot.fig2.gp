...
set term postscript eps enhanced lw 1 size 8.6cm,18cm solid color 18 "fixed"; set out 'fig2.ps'
...
p \
  ...
  JM_2 u ($1*xJM + SHIFT_2):($6*yJM*10000) t '' w l ls 12, \
  JM_1 u ($1*xJM + SHIFT_1):($6*yJM*10000) t '' w l ls 11
