...
JM_1    = '../../output/HeSWaveBasisHeIon/HeSWaveBasisHeIon_TCS_Nc3_L0_LMBD0.95_avr_1.05_N100_Nt30.dat'
TICS_1  = '../../output/HeSWaveBasisHeIon/HeSWaveBasisHeIon_TICS_Nc3_L0_LMBD0.95_avr_1.05_N100_Nt30.dat'
LABEL_1 = '{/Symbol l}';
SHIFT_1 = 0;

JM_3    = '../../output/HeSWaveBasisHeIon/HeSWaveBasisHeIon_TCS_Nc3_L0_LMBD1.0_N101_Nt25_avr_35.dat'
TICS_3  = '../../output/HeSWaveBasisHeIon/HeSWaveBasisHeIon_TICS_Nc3_L0_LMBD1.0_N101_Nt25_avr_35.dat'
LABEL_3 = 'N_t';
SHIFT_3 = 0;
...
set style line 11 lt 1 lc -1   lw 1  pt 1 ps 1 pi 2   # lc 3 blue line; lc 1 red
set style line 12 lt 1 lc 1    lw 2  pt 7 ps 1 
set style line 13 lt 1 lc 3    lw 3  pt 7 ps 1 

set term postscript eps enhanced lw 1 size 18cm,15cm solid color 18 "fixed"; set out 'fig5.ps'
...
set yrange [2:7];           set ytics 1;  set mytics 5;   
set key right top Right title "(a) 1^1S"
p \
  CCC_1S  u ($1*xCCC):($2*yCCC)    t 'CCC'   w p ls 1, \
  JM_2 u ($1*xJM):($2*yJM) t LABEL_2 w l ls 12,\
  JM_1 u ($1*xJM):($2*yJM) t LABEL_1 w l ls 11
...
set xrange [E_min:120];  set xtics 20;    set mxtics 10;   set format x "%3.0f"; 
set yrange [0.0:5];            set ytics 1;    set mytics 5;   set format y "%3.0f"; 
set key right center Right title "(b) TICS [x0.01]"
p \
  CCC_TICS  u ($1*xCCC):($2*yCCC*100)    t ''   w p ls 1, \
  TICS_2 u ($1*xJM):($2*yJM*100) t '' w l ls 12, \
  TICS_1 u ($1*xJM):($2*yJM*100) t '' w l ls 11
...
set yrange [0:5];            set ytics 1;  set mytics 5;   set format y "%3.0f"; 
...
set yrange [0.8:1.65];           set ytics 0.2;  set mytics 4;   set format y "%3.1f"; 
...
set yrange [2:9];            set ytics 2;  set mytics 4;   set format y "%3.0f"; 
set key right top Right title "(e) 3^3S [x0.001]"
p \
  CCC_t3S  u ($1*xCCC):($2*yCCC*1000)    t ''   w p ls 1, \
  JM_2 u ($1*xJM):($5*yJM*1000) t '' w l ls 12, \
  JM_1 u ($1*xJM):($5*yJM*1000) t '' w l ls 11
