...
/**
 * Dmitry.Konovalov@jcu.edu.au Dmitry.A.Konovalov@gmail.com 28/10/11, 11:10 AM
 */
public class IEEECK { //INTEGER          FUNCTION IEEECK( ISPEC, ZERO, ONE )
public static int IEEECK(
  final int ISPEC    //ISPEC   (input) INTEGER
  , final float ZERO    //ZERO    (input) REAL
  , final float ONE   //ONE     (input) REAL
...
//*
//*     .. Local Scalars ..
  float  NAN1 = 0, NAN2 = 0, NAN3 = 0, NAN4 = 0, NAN5 = 0, NAN6 = 0
    , NEGINF = 0, NEGZRO = 0, NEWZRO = 0, POSINF = 0; //REAL               NAN1, NAN2, NAN3, NAN4, NAN5, NAN6, NEGINF,NEGZRO, NEWZRO, POSINF
//*     ..
...
//*
  if ( ISPEC == 0 )
    return IEEECK; // //IF( ISPEC.EQ.0 )RETURN
//*
