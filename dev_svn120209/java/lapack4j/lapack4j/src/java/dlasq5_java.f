...
public static void DLASQ5( I0, N0, Z, PP, TAU, DMIN, DMIN1, DMIN2, DN,DNM1, DNM2, IEEE ) { //SUBROUTINE DLASQ5( I0, N0, Z, PP, TAU, DMIN, DMIN1, DMIN2, DN,DNM1, DNM2, IEEE )
//*
...
double DMIN, DMIN1, DMIN2, DN, DNM1, DNM2, TAU; //DOUBLE PRECISION   DMIN, DMIN1, DMIN2, DN, DNM1, DNM2, TAU
//*     ..
//*     .. Array Arguments ..
...
//*
if ( PP == 0 ) { //IF( PP.EQ.0 ) THEN
for ( 30 J4 = 4*I0; 4*( N0-3 ); 4) { //DO 30 J4 = 4*I0, 4*( N0-3 ), 4
Z( J4-2 ) = D + Z( J4-1 ); //Z( J4-2 ) = D + Z( J4-1 )
...
for ( 40 J4 = 4*I0; 4*( N0-3 ); 4) { //DO 40 J4 = 4*I0, 4*( N0-3 ), 4
Z( J4-3 ) = D + Z( J4 ); //Z( J4-3 ) = D + Z( J4 )
if ( D < ZERO ) { //IF( D.LT.ZERO ) THEN
} // RETURN
} else { // ELSE
