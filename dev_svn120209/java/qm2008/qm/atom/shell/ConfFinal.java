 ...
 */
public class ConfFinal extends LsConf {  // this class is for using config, NOT building it.
  public static Log log = Log.getLog(ConfFinal.class);
  private int[] arrQ;

  public ConfFinal(final LsConf from) {  // nov2010 - ConfFinal looks odd?! cleanup if not needed.
    super(from);
