...
/**
 * Created by Dmitry.A.Konovalov@gmail.com using IntelliJ, 28/09/2009, 10:45:23 AM
 */
public class SeqArrFilterOptUI extends GridBagView {
  ...
  public SeqArrFilterOptUI(FastaOpt model) {
    init();
    loadFrom(model);
    assemble();       // called from loadFrom(project);
  }

  public void loadTo(FastaOpt model) {  // <---- REMEMBER TO UPDATE when adding new option views
...
//    exportView.loadTo(model);
  ...
  public void loadFrom(FastaOpt model) {
