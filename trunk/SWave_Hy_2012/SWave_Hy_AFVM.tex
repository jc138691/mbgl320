...
\beq
\vec{d}_0 = [ \vec{b}_0
-  {\bf X}^T \vec{b}_1 ]  / \beta_0 ,\\
\eeq
{\bf TODO: remove (2/k); correct K-matrix final eqs.}
\beq
...
\eeq
\beq \barr{l}
[M_{0 \epsilon'}]_{\gamma \gamma'} = D_1 + D_2 + (-1)^S D_3,\\
D_1 = \langle \Phi_\gamma \phi_{\gamma}  | H_t + \hat{K}_2-E_i |
\Phi_{\gamma'} \phi_{\epsilon' \gamma'} \rangle, \\
D_2 = \langle \Phi_\gamma \phi_{\gamma}  | V |
\Phi_{\gamma'} \phi_{\epsilon' \gamma'} \rangle, \\
D_3 = \langle \Phi_\gamma \phi_{\gamma}  | H -E_i |
\phi_{\epsilon' \gamma'} \Phi_{\gamma'}  \rangle, \\
H_t = \hat{K}_1 + v_1, \\
H = H_t + \hat{K}_2 + V, \ \ \ V = v_2 + v_{12},\\
\earr \label{Y_B_W} \eeq
\beq
\phi_{\gamma} = \psi_{\gamma} - \overline{\phi}_{\gamma}, \ \ \ \overline{\phi}_{\gamma} \equiv \hat{P}_N \psi_\gamma,
\eeq
\beq
D_1 = -\delta_{\gamma \gamma'} \langle \overline{\phi}_{\gamma}  | \hat{K}_2|
 \phi_{\epsilon' \gamma} \rangle,
\eeq
\beq
D_2 = \delta_{\gamma \gamma'} \langle \phi_{\gamma}  | v |
\phi_{\epsilon' \gamma'} \rangle +
\langle \Phi_\gamma \phi_{\gamma}  | v_{12} |
\Phi_{\gamma'} \phi_{\epsilon' \gamma'} \rangle,
\eeq
\beq
