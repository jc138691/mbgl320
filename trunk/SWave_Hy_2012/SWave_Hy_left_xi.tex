...
\beq
\langle \vec{\eta} |H-E_i|\Psi_{E_i}^{\Gamma}\rangle=0,
...
The solution ONE:
\beq
\vec{y} = {\bf M}_{1}^{-1} \vec{g}, \ \ \ \
{\bf X} = {\bf M}_{1}^{-1} {\bf M}_{0},
\eeq
\beq
\vec{a}_1= - c_i \vec{y}   - {\bf X} \vec{a}_0,
\eeq
\beq
c_i = [ \vec{b}_0 \cdot \vec{a}_0
- \vec{b}_1 \cdot {\bf X} \vec{a}_0 ]  / \beta ,\ \ \
\beta = \vec{b}_1 \cdot  \vec{y},
\eeq
...
\eeq
\beq
[a_1]_{\gamma \sigma}= - y_\gamma d_\sigma   - X_{\gamma \sigma}
\eeq
\beq
c_i = \sum_\gamma d_\gamma, \ \ \
\vec{d} = [ \vec{b}_0
-  {\bf X}^T \vec{b}_1 ]  / \beta.\\
\eeq
