...
public static void DLASQ3( I0, N0, Z, PP, DMIN, SIGMA, DESIG, QMAX, NFAIL,ITER, NDIV, IEEE, TTYPE, DMIN1, DMIN2, DN, DN1,DN2, G, TAU ) { //SUBROUTINE DLASQ3( I0, N0, Z, PP, DMIN, SIGMA, DESIG, QMAX, NFAIL,ITER, NDIV, IEEE, TTYPE, DMIN1, DMIN2, DN, DN1,DN2, G, TAU )
//*
...
int I0, ITER, N0, NDIV, NFAIL, PP; //INTEGER            I0, ITER, N0, NDIV, NFAIL, PP
double DESIG, DMIN, DMIN1, DMIN2, DN, DN1, DN2, G,QMAX, SIGMA, TAU; //DOUBLE PRECISION   DESIG, DMIN, DMIN1, DMIN2, DN, DN1, DN2, G,QMAX, SIGMA, TAU
//*     ..
//*     .. Array Arguments ..
...
{  ZERO = 0.0D0, QURTR = 0.250D0, HALF = 0.5D0,ONE = 1.0D0, TWO = 2.0D0, HUNDRD = 100.0D0 ; } //PARAMETER          ( ZERO = 0.0D0, QURTR = 0.250D0, HALF = 0.5D0,ONE = 1.0D0, TWO = 2.0D0, HUNDRD = 100.0D0 )
//*     ..
//*     .. Local Scalars ..
