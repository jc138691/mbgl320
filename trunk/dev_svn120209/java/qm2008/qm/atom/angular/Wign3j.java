...
import math.Mathx;
//import static math.Mathx.*;
//import static java.lang.Math.*;
/**
 *  dmitry.konovalov@jcu.edu.au Date: 15/07/2008, Time: 12:00:10
 */
public class Wign3j {
  ...
  public static double wign6j2(int IA, int IB, int IC, int IX, int IY, int IZ) {
    return calcWign6j2L(false, false, IA, IB, IC, IX, IY, IZ);
  }
...
/*
*
* $Id: Wign3j.java,v 1.3 2005/10/06 18:00:19 jc138691 Exp $
*
* $Log: Wign3j.java,v $
