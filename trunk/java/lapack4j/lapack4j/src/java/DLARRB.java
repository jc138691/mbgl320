...
public static void DLARRB(
  ...
  , double[] LLD  //LLD     (input) DOUBLE PRECISION array, dimension (N-1)
  , int IFIRST  //IFIRST  (input) INTEGER
  , int ILAST  //ILAST   (input) INTEGER
  , double RTOL1  //RTOL1   (input) DOUBLE PRECISION
  , double RTOL2  //RTOL2   (input) DOUBLE PRECISION
  , int OFFSET  //OFFSET  (input) INTEGER
  , double[] W  //W       (input/output) DOUBLE PRECISION array, dimension (N)
  , double[] WGAP  //WGAP    (input/output) DOUBLE PRECISION array, dimension (N-1)
  ...
  //*
  //*     .. Scalar Arguments ..
  int INFO = 0; //INTEGER            IFIRST, ILAST, INFO, N, OFFSET, TWIST
