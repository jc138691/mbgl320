 ...
 */
public class JmLagrrLcrTest extends FlowTest {
  private static JmLagrrLcr arr;
  public JmLagrrLcrTest(JmLagrrLcr basis) {
    super(JmLagrrLcrTest.class);
    arr = basis;
  }
  public JmLagrrLcrTest() {
  }

  public void testNorm() {
//    TaskProgressMonitor monitor = ProjectProgressMonitor.getInstance();
//
    log.dbg("testing JmLagrrLcr: JM-Laguerre function normalization");
