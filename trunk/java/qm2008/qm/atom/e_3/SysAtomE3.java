...
//    }
  ...
  public Energy calcOverlap(Conf fc, Conf fc2) {
    throw new IllegalArgumentException(log.error("SysAtomE3.calcOverlap(Conf sa, Conf sa2) todo"));
  }
  @Override
  public FuncVec calcDensity(Conf cf, Conf cf2) {
    throw new IllegalArgumentException(log.error("SysAtomE3.calcDensity(Conf cf, Conf cf2) TODO "));
  }
